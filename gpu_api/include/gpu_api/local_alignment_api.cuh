...
public:
    using GpuSubstitutionMatrixType = GpuSubstitutionMatrix<AlignmentType::LocalAlignment, typename ToScoreType32<ScoreType>::type, alphabetSizeWithPadding>;
private:
    ...
    */
    ...
    void oneToOne_shortQuery(
        ...
        if(sharedMemoryApproach == SharedMemorySubstitutionMatrixApproach::Impossible){
            ...
            auto kernel = localalignment::alphabet_substitutionmatrix_half2OrShort2_kernel<
                alphabetSize,
                ScoreType, 
                penaltyType, 
                blocksize, 
    ...
    void oneToOne_longQuery(
        ...
        if(sharedMemoryApproach == SharedMemorySubstitutionMatrixApproach::Impossible){
            ...
            using SUBMAT = typename KernelSubstitutionMatrixInformation::SUBMAT_squared_oneToOne;
            auto kernel = localalignment::alphabet_substitutionmatrix_half2OrShort2_multipass_kernel<
                alphabetSize,
                ScoreType, 
                penaltyType, 
                blocksize, 
...
private:
    ...
    SharedMemorySubstitutionMatrixApproach selectSharedMemorySubstitutionMatrixApproachAndSetSmemKernelAttribute_shortQuery(){
        ...
        using SUBMAT_squared = typename KernelSubstitutionMatrixInformation::SUBMAT_squared_oneToOne;
        constexpr SubstitutionMatrixDimensionMode dimMode_squared 
            = KernelSubstitutionMatrixInformation::dimMode_squared_oneToOne;

        auto kernel_squaredpacked = localalignment::alphabet_substitutionmatrix_half2OrShort2_kernel<
            alphabetSize,
            ScoreType, 
            penaltyType, 
            blocksize, 
        ...
        if(status == cudaSuccess){
            ...
            using SUBMAT_unpacked = typename KernelSubstitutionMatrixInformation::SUBMAT_unpacked_oneToOne;

            constexpr SubstitutionMatrixDimensionMode dimMode_SUBMAT_unpacked 
                = KernelSubstitutionMatrixInformation::dimMode_unpacked_oneToOne;

            auto kernel_unpacked = localalignment::alphabet_substitutionmatrix_half2OrShort2_kernel<
                alphabetSize,
                ScoreType, 
                penaltyType, 
                blocksize, 
    ...
    SharedMemorySubstitutionMatrixApproach selectSharedMemorySubstitutionMatrixApproachAndSetSmemKernelAttribute_longQuery(){
        ...
        auto kernel_squaredpacked = localalignment::alphabet_substitutionmatrix_half2OrShort2_multipass_kernel<
            alphabetSize,
            ScoreType, 
            penaltyType, 
            blocksize, 
        ...
        if(status == cudaSuccess){
            ...
            auto kernel_unpacked = localalignment::alphabet_substitutionmatrix_half2OrShort2_multipass_kernel<
                alphabetSize,
                ScoreType, 
                penaltyType, 
                blocksize, 
